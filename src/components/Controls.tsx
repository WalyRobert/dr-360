  ...
  return (
    <>
      ...
      >
        ...
        {/* Control Dock Bottom - EXPANDED WITH 2 LINES */}
        <div className={`p-4 md:p-6 space-y-3 flex flex-col items-center transition-all ${visible ? 'pointer-events-auto translate-y-0' : 'translate-y-[20px]'}`}>
          <div className="w-full max-w-5xl bg-black/50 backdrop-blur-xl p-4 rounded-none border border-dr-gold/20 shadow-2xl">
            {/* Progress Bar */}
            ...
            {/* Controls Line 1 - Volume, Play, View Modes */}
            <div className="flex items-center justify-between gap-2 mb-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  className="w-20 h-0.5 bg-dr-gray/10 accent-dr-gold appearance-none cursor-pointer"
                />
              </div>
              ...
              <div className="flex items-center space-x-2 gap-1">
                <button
                  ...
                  className="px-2 py-1 text-dr-gold font-bold text-[8px] tracking-widest hover:text-dr-goldLight bg-transparent border border-dr-gold/20 rounded hover:border-dr-gold/50 transition-all"
            ...
            {/* Controls Line 2 - Head Tracking, VR, Fullscreen */}
